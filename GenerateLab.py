...
def generate_lab_files(word_file_name: str, folder_wav_files: str, new_folder_lab_files: str):
    ...
    if (file_exists(word_file_name) and
        ...
        #Removing apostrophies from the sentences in the paragraphs to make it easier to analyse in the future
        apostropheless_text_doc = []
        for paragraphs in text_doc:
            new_paragraph = paragraphs.replace("’", " ")
            apostropheless_text_doc.append(new_paragraph)


        text_doc = apostropheless_text_doc
