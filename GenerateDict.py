...
#This checks whether there is a already a file called 'this_file' when the user attempts to name the new file 'this_file'
...
def generate_dict(oov_file_name: str, original_dict_file_name: str, new_dict_file_name: str) -> None:
    ...
    if (file_exists(oov_file_name) and
        ...
        #Convert text dictionary format into python dictionary format
        ...
        #Finnish and write the words to a new file
        new_dict_file_list = []
